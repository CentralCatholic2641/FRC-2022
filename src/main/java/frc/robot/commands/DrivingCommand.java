...
public class DrivingCommand extends CommandBase {
  ...
  public void execute() {
    ...
    double joystick1 = Robot.robotContainer.gamepad1.getRawAxis(Constants.lyAxis);
    double joystick2 = Robot.robotContainer.gamepad1.getRawAxis(Constants.ryAxis);
    Robot.drivingSubsystem.tDrive(joystick1, -joystick2);

    // double joystick1 =
    // Robot.robotContainer.gamepad1.getRawAxis(Constants.joystick2);
    // double joystick2 =
    // Robot.robotContainer.gamepad1.getRawAxis(Constants.joystick1);
